<template>
    <el-main>
      ...
      <p>
        <a style="text-decoration: underline" href="https://www.10t7.tech" target="_blank">博客前台演示</a><br /><br/>
        <a style="text-decoration: underline" href="https://admin.10t7.tech" target="_blank">后台管理演示</a>
      </p>
      <br />
      ...
      <p>
        ...
        >
        以及
        <a style="text-decoration: underline" href="https://element.eleme.cn/#/zh-CN" target="_blank"
          >element-ui</a
        >
        <br/>
      ...
      <p>
        基于
        <a style="text-decoration: underline" href="https://material-landing.vuetifyjs.com/" target="_blank"
          >vuetify官方主题</a
        >以及
        <a style="text-decoration: underline" href="https://vuetify.cn/zh-Hans/" target="_blank">vuetify-ui</a>
      </p>
